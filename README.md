...
# 作成
gh repo create ChkDbConn --private
# 確認
gh repo list | Select-String ChkDbConn
```
...
# フォルダが存在する場合は削除
if (Test-Path -Path .\ChkDbConn){rm -Recurse -Force .\ChkDbConn}
# クローン実行
git clone https://github.com/hide104y/ChkDbConn.git
```

## リモートリポジトリ（mainブランチ）にREADME.mdが存在しない場合
```shell
# CD
cd D:\Github\workspace.jre8\ChkDbConn
# ファイル作成
ruby -e "File.write('README.md', '# ChkDbConn', encoding: 'UTF-8')"
# コミット
git add README.md
...
## 依存ライブラリー一覧
```shell
PS D:\Github\workspace.jre8\ChkDbConn> mvn dependency:tree
Picked up JAVA_TOOL_OPTIONS: -Dfile.encoding=UTF-8 -Dsun.stdout.encoding=UTF-8 -Dsun.stderr.encoding=UTF-8
[INFO] Scanning for projects...
[INFO]
[INFO] ---------------------------< tool:ChkDbConn >---------------------------
[INFO] Building ChkDbConn 1.0
[INFO]   from pom.xml
[INFO] --------------------------------[ jar ]---------------------------------
[INFO]
[INFO] --- dependency:3.7.0:tree (default-cli) @ ChkDbConn ---
[INFO] tool:ChkDbConn:jar:1.0
[INFO] +- junit:junit:jar:4.13.2:test
[INFO] |  \- org.hamcrest:hamcrest-core:jar:1.3:test
[INFO] +- com.h2database:h2:jar:2.2.224:test
[INFO] +- com.mysql:mysql-connector-j:jar:9.7.0:compile
...
[INFO] +- com.microsoft.sqlserver:mssql-jdbc:jar:13.4.0.jre8:compile
[INFO] \- com.oracle.database.jdbc:ojdbc8:jar:23.26.3.0.0:compile
[INFO] ------------------------------------------------------------------------
[INFO] BUILD SUCCESS
[INFO] ------------------------------------------------------------------------
[INFO] Total time:  0.860 s
[INFO] Finished at: 2026-08-20T00:16:29+09:00
[INFO] ------------------------------------------------------------------------
PS D:\Github\workspace.jre8\ChkDbConn>
```

## コーディング
- pom.xml
- src\main\java\tool\ChkDbConn.java
- src\main\java\tool\ClsDatabase.java
...
cd D:\Github\workspace.jre8
agy
.\ChkDbConn\src配下のソースに対して、スキル「source-review」を実行して
/exit
```
...
# Usage
java -jar target\ChkDbConn-1.0-jre8.jar -h
```
...
## リモートリポジトリを確認
- https://github.com/hide104y/ChkDbConn/tree/java08
...
if (Test-Path -Path .\ChkDbConn){rm -Recurse -Force .\ChkDbConn}
# クローン実行
git clone -b java08 https://github.com/hide104y/ChkDbConn.git
```
